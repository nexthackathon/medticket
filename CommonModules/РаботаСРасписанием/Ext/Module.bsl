...
Функция ПолучитьВсюИнформациюПоРецептам(Пациент)
	...
	Если не РезультатыЗапроса.Количество() тогда
		
		ТЗ_Рецептов	=РезультатыЗапроса[4];
		ТЗ_Лекарств	=РезультатыЗапроса[5];
		ТЗ_Аптек	=РезультатыЗапроса[6];
